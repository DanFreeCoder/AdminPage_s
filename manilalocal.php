...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1><i class="bi bi-telephone"></i></i>Manila Locals</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="cebulocal.php">Local Numbers</a></li>
                    <li class="breadcrumb-item active">Manila Locals</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="d-flext justify-content-start mb-2">
                            <div data-bs-toggle="modal" data-bs-target="#manila-modal" class="fa-light fa-pen-to-square btn btn-success"><i class="bi bi-plus"></i>New</div>
                            <div id="edit_manila" class="fa-light fa-pen-to-square btn btn-primary"> <i class="bi bi-pencil-square"></i> Edit </div>
                            <div class="btn btn-danger" id="delete_manila"> <i class="bi bi-trash3"></i> Delete </div>
                        </div>
                        <div class="card post">
                            <table id="table" class="table table-dark table-striped mt-3" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
    ...
    <!-- Modal -->
    <div class="modal fade" id="manila-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- Modal edit -->
    <div class="modal fade" id="edit_manila_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Local Number Details</h1>
                ...
                <div class="modal-body" id="edit_manila_body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.status').on('click', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'controls/retrieve_manila_data.php',
                    data: mydata,
    ...
    <script>
        $('#btn_save').on('click', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'controls/save_manila_locals.php',
                data: mydata,
    ...
    <script>
        $('#check_all').change(function(e) {
            ...
            if ($(this).prop('checked')) {
                ...
                $("#edit_manila").hide(500);
            } else {
                $('tbody tr td input[type="checkbox"]').each(function() {
                    $('td input:checkbox', table).prop('checked', false);
                });
                $("#edit_manila").show(500);
            }
    ...
    <script>
        $('#edit_manila').on('click', function(e) {
            e.preventDefault();

            const id = $('input:checkbox[name=form_manila]:checked').attr('value');
            if (id == null) {
                alert('Please select specific user.')
            } else {
                $.ajax({
                    type: 'POST',
                    url: 'controls/display_manila.php',
                    data: {
                        id: id
                    },
                    ...
                    success: function(html) {
                        ...
                        $('#edit_manila_modal').modal('show');
                        $('#edit_manila_body').html(html);
                    }
                })
            }
    ...
    <script>
        $('#btn_update').on('click', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'controls/update_manila_locals.php',
                data: mydata,
    ...
    <script>
        $('#delete_manila').on('click', function(e) {
            e.preventDefault();

            var form_id = []

            $('input:checkbox[name=form_manila]:checked').each(function() {
            ...
            if (form_id < 1) {
                ...
                if (confirm('Warning: Are you sure to remove this user?')) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controls/delete_manila.php',
                        data: {
                            id: form_id
                        },
